    ...
    <body>
      <div className="home-page" style={{ paddingTop: "110px" }}>
        <section className="hero">
          ...
          <p>
            A Eco Move é uma solução inteligente que conecta pessoas a meios de
            transporte sustentáveis, como bicicletas, caronas compartilhadas,
            veículos elétricos e rotas integradas com transporte público. Tudo
        ...
        <section className="funcionabilidades">
          ...
          <div className="feature">
            ...
            <p>
              Visualize e publique viagens facilmente. Encontre opções com base
              na origem e destino.
            </p>
          </div>
          ...
          <div className="feature">
            ...
            <p>
              Design pensado para todos, com fácil navegação e acessibilidade
              garantida.
            </p>
          </div>
        </section>
        ...
        <section className="comofunciona">
          <h1 className="lista">
            Como Funciona a Plataforma de Mobilidade Sustentavel
          </h1>
          <p>
          ...
          <div className="feature">
            ...
            <p>
              Você pode usar a versão web ou baixar o app no seu celular. Basta
              criar uma conta para começar a explorar.
            </p>
          </div>
          ...
          <div className="feature">
            ...
            <p>
              A plataforma conecta usuários com rotas semelhantes, permitindo
              que compartilhem caronas com segurança, reduzindo custos e
              emissões.
            </p>
          </div>
          ...
          <div className="feature">
            ...
            <p>
              Se você dirige um veículo elétrico, é possível visualizar os
              pontos de recarga próximos, ver sua disponibilidade em tempo real
              e até agendar um horário.
            </p>
          </div>
          ...
          <div className="feature">
            ...
            <p>
              O sistema calcula automaticamente quanto CO₂ você economizou,
              quantos quilômetros sustentáveis percorreu e oferece um ranking
              ecológico com recompensas.
            </p>
          </div>
          ...
          <div className="feature">
            ...
            <p>
              Cada escolha sustentável vira ponto. Com eles, você pode resgatar
              descontos em produtos ecológicos, participar de sorteios ou ganhar
              brindes exclusivos.
            </p>
          </div>
        </section>
