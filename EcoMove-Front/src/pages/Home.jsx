...
function Home() {
  return (
    <div className="home-container" style={{paddingTop: 200}}>
      ...
      <h1>Compartilhe o caminho, <br/><span class="highlight">conecte pessoas</span></h1>
      <p>
        A Eco Move é uma solução inteligente que conecta pessoas a meios de transporte sustentáveis, 
        como bicicletas, caronas compartilhadas, veículos elétricos e transporte público. 
        Tudo isso com tecnologia e impacto positivo para o planeta.
      </p>
      <div class="buttons">
        <a href="#" class="btn-primary">Cadastre-se Agora</a>
    ...
    <div class="hero-image">
      <img src={Info} alt="Eco Move Ilustração"/>
        ...
        <section className="funcionalidades">
          ...
          <p className="features-subtitle">
            Nossa plataforma foi desenvolvida para tornar o compartilhamento de caronas uma
            experiência simples, segura e agradável.
          </p>
          <div className="features-cards">
            ...
            <div className="feature-card">
              ...
              <p>Verificação de identidade e normas claras para uma comunidade respeitosa e confiável.</p>
            </div>
        ...
        <section className="steps-section">
          ...
          <p className="steps-description">
            A Eco Move conecta tecnologia, sustentabilidade e mobilidade urbana em um só lugar. De forma simples e intuitiva, ela ajuda as pessoas a se locomoverem pela cidade de forma mais eficiente, econômica e amiga do meio ambiente.
          </p>
          ...
          <div className="steps-cards">
            ...
            <div className="step-card">4. Localize Estações de Recarga Elétrica</div>
      ...
      <footer className="footer-section">
        <div className="footer-brand">
          <span className="eco">ECO</span><span className="move">MOVE</span>
        </div>
      </footer>
    </div>
  );
